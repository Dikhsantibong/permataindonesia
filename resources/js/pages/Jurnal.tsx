...
export default function Jurnal({ documents }: Props) {
    ...
    return (
        <FrontLayout>
            <Head title="Kajian Organisasi & Karya Tulis Mahasiswa | Permata Indonesia" />
            <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
                <h1 className="text-3xl font-bold text-[#0B1727] mb-6 border-b-2 border-[#FACC15] pb-2 inline-block">
                    Kajian Organisasi & Karya Tulis Mahasiswa
                </h1>

                <div className="mt-8">
                    <p className="text-gray-600 mb-8 max-w-2xl">
                        Kumpulan jurnal dan karya tulis ilmiah mahasiswa pertambangan Indonesia untuk referensi dan pengembangan akademik.
                    </p>
                    ...
                    {documents.last_page > 1 && (
                        <div className="flex items-center justify-between mt-6">
                            <p className="text-sm text-gray-500">
                                Total {documents.total} publikasi
                            </p>
