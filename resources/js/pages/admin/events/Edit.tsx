...
export default function EventEdit({ event }: Props) {
    ...
    const [imagePreview, setImagePreview] = useState<string | null>(
        event.cover_image ? `/storage/${event.cover_image}` : null
    );
        ...
        <>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-4">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Edit Kegiatan</h1>
                        <p className="text-sm text-gray-500 dark:text-gray-400">Perbarui informasi kegiatan</p>
                    </div>
                </div>
                        ...
                        <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-900">
                            ...
                            {imagePreview ? (
                                ...
                                >
                                    ...
                                    <div>
                                        <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Klik untuk upload baru</p>
