...
export default function GalleryEdit({ item }: Props) {
    ...
    function handleSubmit(e: FormEvent) {
        e.preventDefault();
        post(`/admin/gallery/${item.id}`, { forceFormData: true });
    }
        ...
        <>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-4">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Edit Foto</h1>
                        <p className="text-sm text-gray-500 dark:text-gray-400">Perbarui informasi foto kegiatan.</p>
                    </div>
                </div>
                    ...
                    <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-900">
                        ...
                        {imagePreview ? (
                            ...
                            >
                                ...
                                <div>
                                    <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Klik untuk upload foto baru</p>
